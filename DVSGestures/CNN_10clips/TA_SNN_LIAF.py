...
from DVSGestures.CNN_10clips.Networks.TA_SNN_LIAF_CNN_3 import create_net
...
def main():
    ...
    config.name = 'TA_SNN(CNN)_LIAF-DVS-Gesture-10clips_dt=' + str(config.dt) + 'ms' + '_T=' + str(config.T)
